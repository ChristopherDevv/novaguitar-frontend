...
/* función acceptAndClose que se llama cuando el usuario hace clic en el botón “Accept”. Esta función primero 
llama a la función que se pasó a través de la propiedad onAccept (en este caso, incrementar), y luego cierra 
el modal llamando a la función closeModal. */
